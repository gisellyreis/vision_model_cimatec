...
def main():
    ...
    parser.add_argument("--model", type=str, default="v5", help="Model name (v5, v8, v10, rcnn)")
    ...
    model_paths = {
        "v5": "../weights/v1_yolov5.pt",
        "v8": "../weights/v1_yolov8.pt",
        "v10": "../weights/v1_yolov10.pt",
        "rcnn": "../weights/v1_fasterRCNN.pth"
    }
