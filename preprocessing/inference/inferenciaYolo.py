...
dataset_root = "/scratch/academico-cimatec/ccad/vision_model_cimatec/datasets"
dataset_name = "mobdrone"

modelo_path = os.path.join(base_dir, "yolov8n.pt")
dataset_yaml = os.path.join(dataset_root, dataset_name, "datamob.yaml")
caminho_imagens = [
    os.path.join(dataset_root, dataset_name, "images", split, "*.png")
